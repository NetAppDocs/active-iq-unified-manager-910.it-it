...
====
Per ulteriori informazioni sulle soglie di performance dinamiche, consulta _quali sono gli eventi_. Per informazioni su come Unified Manager classifica i carichi di lavoro e determina l'ordinamento, consulta _come Unified Manager determina l'impatto delle performance per un evento_.
...
+
Visualizza i dettagli sull'utilizzo del carico di lavoro del componente del cluster in conflitto. Nei grafici, l'utilizzo effettivo è una linea blu. Una barra rossa evidenzia la durata dell'evento, dal tempo di rilevamento all'ultimo tempo analizzato. Per ulteriori informazioni, consulta _misurazioni delle performance del carico di lavoro_.
